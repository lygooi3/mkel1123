...
#define AI_NETWORK_MODEL_SIGNATURE     "9959dd0965b81792b2bdac477431496f"
...
#define AI_TOOLS_DATE_TIME   "Sun Jul 10 21:47:17 2022"
...
AI_ARRAY_OBJ_DECLARE(
  dense_72_input_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
AI_TENSOR_OBJ_DECLARE(
  dense_72_input_output, AI_STATIC,
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 1, 1), AI_STRIDE_INIT(4, 4, 4, 16, 16),
  1, &dense_72_input_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_72_input_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 82944, 1, 1),
    82944, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1024, 1, 1),
    1024, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &dense_72_input_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    dense_72_input_output_array.data = AI_PTR(g_network_activations_map[0] + 496);
    dense_72_input_output_array.data_start = AI_PTR(g_network_activations_map[0] + 496);
    
    dense_0_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    dense_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
    ...
    dense_3_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    dense_3_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_0_weights_array.data = AI_PTR(g_network_weights_map[0] + 0);
    ...
    dense_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 16896);
    dense_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 16896);
    
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(g_network_weights_map[0] + 82432);
    dense_3_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 82432);
